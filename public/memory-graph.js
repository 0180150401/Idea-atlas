...
`,
  ...
  // .svelte-build/MemoryGraph.js
  var root = from_html(`<div class="emptyState svelte-1rjkhpa"><h2 class="svelte-1rjkhpa">No memory nodes yet</h2> <p class="svelte-1rjkhpa">Upload material first. The graph will appear here automatically.</p></div>`);
  var root_1 = from_svg(`<line class="memoryEdge svelte-1rjkhpa"></line>`);
  var root_2 = from_svg(`<line></line>`);
  var root_3 = from_svg(`<g role="button" tabindex="0"><circle class="halo svelte-1rjkhpa" r="42"></circle><circle r="24" class="svelte-1rjkhpa"></circle><text class="svelte-1rjkhpa"> </text></g>`);
  var root_4 = from_svg(`<svg aria-label="Memory brain node network" class="svelte-1rjkhpa"><defs><radialGradient id="nodeGlow"><stop offset="0%" stop-color="currentColor" stop-opacity="0.22"></stop><stop offset="100%" stop-color="currentColor" stop-opacity="0"></stop></radialGradient></defs><circle class="core svelte-1rjkhpa" r="76"></circle><text class="coreText svelte-1rjkhpa">memory / brain</text><!><!><!></svg>`);
  var root_5 = from_html(`<p class="svelte-1rjkhpa"><strong class="svelte-1rjkhpa"> </strong> </p>`);
  var root_6 = from_html(`<div class="metadata svelte-1rjkhpa"><p class="svelte-1rjkhpa"><strong class="svelte-1rjkhpa">relationships</strong></p> <!></div>`);
  var root_7 = from_html(`<h2 class="svelte-1rjkhpa"> </h2> <p class="typePill svelte-1rjkhpa"> </p> <pre class="svelte-1rjkhpa"> </pre> <div class="metadata svelte-1rjkhpa"></div> <!>`, 1);
  var root_8 = from_html(`<h2 class="svelte-1rjkhpa">Select a node</h2> <p>Click through the network to preview uploaded material and inferred metadata.</p>`, 1);
  var root_9 = from_html(`<div class="memoryShell svelte-1rjkhpa"><section class="networkPanel svelte-1rjkhpa"><!></section> <aside class="previewPanel svelte-1rjkhpa"><p class="eyebrow svelte-1rjkhpa">Material Preview</p> <!></aside></div>`);
  var $$css = {
    hash: "svelte-1rjkhpa",
    code: ":host {display:block;color:#201a15;font-family:Arial, Helvetica, sans-serif;}.memoryShell.svelte-1rjkhpa {display:grid;gap:20px;grid-template-columns:minmax(0, 1fr) minmax(280px, 360px);}.networkPanel.svelte-1rjkhpa,\n  .previewPanel.svelte-1rjkhpa {background:#fffaf2;border:1px solid #ded4c8;border-radius:24px;min-height:680px;overflow:hidden;}.networkPanel.svelte-1rjkhpa {background:radial-gradient(circle at 50% 45%, rgba(75, 56, 41, 0.12), transparent 48%),\n      #f7f2ea;}svg.svelte-1rjkhpa {display:block;height:680px;width:100%;}.core.svelte-1rjkhpa {fill:rgba(75, 56, 41, 0.16);stroke:#4b3829;stroke-width:2;}.coreText.svelte-1rjkhpa,\n  .memoryNode.svelte-1rjkhpa text:where(.svelte-1rjkhpa) {fill:#201a15;font-size:13px;font-weight:700;paint-order:stroke;pointer-events:none;stroke:#f7f2ea;stroke-width:5px;text-anchor:middle;}.memoryEdge.svelte-1rjkhpa {stroke:rgba(117, 107, 98, 0.35);stroke-dasharray:6 10;stroke-width:1.4;}.relationshipEdge.svelte-1rjkhpa {stroke:rgba(75, 56, 41, 0.68);stroke-width:2.2;}.relationshipEdge.confirmed.svelte-1rjkhpa {stroke:rgba(34, 94, 58, 0.82);}.relationshipEdge.rejected.svelte-1rjkhpa {stroke:rgba(140, 58, 58, 0.45);stroke-dasharray:4 8;}.relationshipEdge.derived.svelte-1rjkhpa {stroke:rgba(117, 107, 98, 0.55);stroke-dasharray:2 6;}.memoryNode.svelte-1rjkhpa {cursor:pointer;outline:none;}.memoryNode.svelte-1rjkhpa .halo:where(.svelte-1rjkhpa) {fill:url(#nodeGlow);color:#4b3829;}.memoryNode.svelte-1rjkhpa circle:where(.svelte-1rjkhpa):not(.halo) {fill:#fffaf2;stroke:#ded4c8;stroke-width:2;transition:fill 0.18s,\n      r 0.18s,\n      stroke-width 0.18s;}.memoryNode.svelte-1rjkhpa:hover circle:where(.svelte-1rjkhpa):not(.halo),\n  .memoryNode.svelte-1rjkhpa:focus circle:where(.svelte-1rjkhpa):not(.halo),\n  .memoryNode.selected.svelte-1rjkhpa circle:where(.svelte-1rjkhpa):not(.halo) {fill:#ead8c3;stroke:#4b3829;stroke-width:4;}.previewPanel.svelte-1rjkhpa {display:flex;flex-direction:column;gap:14px;padding:24px;}.eyebrow.svelte-1rjkhpa {color:#756b62;font-size:12px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;}h2.svelte-1rjkhpa {font-size:24px;letter-spacing:-0.03em;line-height:1.05;margin:0;}.typePill.svelte-1rjkhpa {align-self:flex-start;background:#f7f2ea;border:1px solid #ded4c8;border-radius:999px;color:#756b62;font-size:12px;padding:7px 10px;}pre.svelte-1rjkhpa {background:#f7f2ea;border:1px solid #ded4c8;border-radius:16px;color:#201a15;line-height:1.55;max-height:320px;overflow:auto;padding:14px;white-space:pre-wrap;}.metadata.svelte-1rjkhpa {display:flex;flex-direction:column;gap:8px;}.metadata.svelte-1rjkhpa p:where(.svelte-1rjkhpa),\n  .emptyState.svelte-1rjkhpa p:where(.svelte-1rjkhpa) {color:#756b62;line-height:1.5;margin:0;}.metadata.svelte-1rjkhpa strong:where(.svelte-1rjkhpa) {color:#201a15;display:block;font-size:12px;letter-spacing:0.08em;margin-bottom:2px;text-transform:uppercase;}.emptyState.svelte-1rjkhpa {align-items:center;display:flex;flex-direction:column;height:680px;justify-content:center;padding:24px;text-align:center;}\n\n  @media (max-width: 900px) {.memoryShell.svelte-1rjkhpa {grid-template-columns:1fr;}\n  }"
  };
  function MemoryGraph($$anchor, $$props) {
    push($$props, false);
    append_styles($$anchor, $$css);
    const data = mutable_source();
    const graph = mutable_source();
    const selected = mutable_source();
    const selectedEdges = mutable_source();
    let dataJson = prop($$props, "dataJson", 12, '{"thoughts":[],"relationships":[]}');
    ...
    function buildGraph(thoughts, relationships) {
      ...
      const nodes = thoughts.map((thought, index2) => {
        const angle = Math.PI * 2 * index2 / Math.max(thoughts.length, 1) - Math.PI / 2;
        const radius = 190 + index2 % 4 * 42;
      ...
      const edges = relationships.filter((edge) => nodeIds.has(edge.fromThoughtObjectId) && nodeIds.has(edge.toThoughtObjectId));
      return { width, height, centerX, centerY, nodes, edges };
    }
    function shortLabel(value) {
      return String(value || "memory").replace(/\s+/g, " ").trim().split(" ").slice(0, 4).join(" ");
    }
    function formatMetadata(metadata) {
      const entries = Object.entries(metadata || {}).filter(([, value]) => value !== void 0 && value !== null && value !== "").slice(0, 8);
      if (entries.length === 0) return [["status", "metadata inferred from upload"]];
      return entries.map(([key2, value]) => [key2, Array.isArray(value) ? value.join(", ") : String(value)]);
    }
    legacy_pre_effect(() => deep_read_state(dataJson()), () => {
      set(data, parseData(dataJson()));
    });
    legacy_pre_effect(() => get2(data), () => {
      set(graph, buildGraph(get2(data).thoughts, get2(data).relationships));
    });
    legacy_pre_effect(() => (get2(graph), get2(selectedId)), () => {
      set(selected, get2(graph).nodes.find((node) => node.id === get2(selectedId)) ?? get2(graph).nodes[0]);
    });
    legacy_pre_effect(() => (get2(graph), get2(selectedId)), () => {
      set(selectedEdges, get2(graph).edges.filter((edge) => edge.fromThoughtObjectId === get2(selectedId) || edge.toThoughtObjectId === get2(selectedId)));
    });
    ...
    var node_1 = child(section);
    {
      ...
      var alternate = ($$anchor2) => {
        ...
        each(node_2, 1, () => (get2(graph), untrack(() => get2(graph).nodes)), index, ($$anchor3, node) => {
          var line = root_1();
          template_effect(() => {
            set_attribute2(line, "x1", (get2(graph), untrack(() => get2(graph).centerX)));
            set_attribute2(line, "y1", (get2(graph), untrack(() => get2(graph).centerY)));
            set_attribute2(line, "x2", (get2(node), untrack(() => get2(node).x)));
            set_attribute2(line, "y2", (get2(node), untrack(() => get2(node).y)));
          });
          append($$anchor3, line);
        });
        var node_3 = sibling(node_2);
        each(node_3, 1, () => (get2(graph), untrack(() => get2(graph).edges)), index, ($$anchor3, edge) => {
          const source2 = derived_safe_equal(() => (get2(graph), get2(edge), untrack(() => get2(graph).nodes.find((node) => node.id === get2(edge).fromThoughtObjectId))));
          const target = derived_safe_equal(() => (get2(graph), get2(edge), untrack(() => get2(graph).nodes.find((node) => node.id === get2(edge).toThoughtObjectId))));
            ...
            var consequent_1 = ($$anchor4) => {
              ...
              template_effect(() => {
                set_class(
                  line_1,
                  0,
                  `relationshipEdge ${(get2(edge), untrack(() => get2(edge).lifecycleState || "suggested")) ?? ""}`,
                  "svelte-1rjkhpa"
                );
                set_attribute2(line_1, "x1", (deep_read_state(get2(source2)), untrack(() => get2(source2).x)));
                set_attribute2(line_1, "y1", (deep_read_state(get2(source2)), untrack(() => get2(source2).y)));
                set_attribute2(line_1, "x2", (deep_read_state(get2(target)), untrack(() => get2(target).x)));
                set_attribute2(line_1, "y2", (deep_read_state(get2(target)), untrack(() => get2(target).y)));
              });
              append($$anchor4, line_1);
            };
            if_block(node_4, ($$render) => {
              if (get2(source2) && get2(target)) $$render(consequent_1);
            });
          }
          append($$anchor3, fragment);
        });
        var node_5 = sibling(node_3);
        each(node_5, 1, () => (get2(graph), untrack(() => get2(graph).nodes)), index, ($$anchor3, node) => {
          var g = root_3();
          let classes;
          var circle_1 = child(g);
          var circle_2 = sibling(circle_1);
          var text_1 = sibling(circle_2);
          var text_2 = child(text_1, true);
          reset(text_1);
          reset(g);
          template_effect(() => {
            classes = set_class(g, 0, "memoryNode svelte-1rjkhpa", null, classes, { selected: get2(selected)?.id === get2(node).id });
            set_attribute2(circle_1, "cx", (get2(node), untrack(() => get2(node).x)));
            set_attribute2(circle_1, "cy", (get2(node), untrack(() => get2(node).y)));
            set_attribute2(circle_2, "cx", (get2(node), untrack(() => get2(node).x)));
            set_attribute2(circle_2, "cy", (get2(node), untrack(() => get2(node).y)));
            set_attribute2(text_1, "x", (get2(node), untrack(() => get2(node).x)));
            set_attribute2(text_1, "y", (get2(node), untrack(() => get2(node).y + 44)));
            set_text(text_2, (get2(node), untrack(() => get2(node).label)));
          });
          event("click", g, () => set(selectedId, get2(node).id));
          event("keydown", g, (event2) => event2.key === "Enter" && set(selectedId, get2(node).id));
          append($$anchor3, g);
        });
        reset(svg);
        template_effect(() => {
          set_attribute2(svg, "viewBox", `0 0 ${(get2(graph), untrack(() => get2(graph).width)) ?? ""} ${(get2(graph), untrack(() => get2(graph).height)) ?? ""}`);
          set_attribute2(circle, "cx", (get2(graph), untrack(() => get2(graph).centerX)));
          set_attribute2(circle, "cy", (get2(graph), untrack(() => get2(graph).centerY)));
          set_attribute2(text2, "x", (get2(graph), untrack(() => get2(graph).centerX)));
          set_attribute2(text2, "y", (get2(graph), untrack(() => get2(graph).centerY + 4)));
        });
        append($$anchor2, svg);
      };
      if_block(node_1, ($$render) => {
        if (get2(graph), untrack(() => get2(graph).nodes.length === 0)) $$render(consequent);
        else $$render(alternate, -1);
      });
    }
    reset(section);
    var aside = sibling(section, 2);
    var node_6 = sibling(child(aside), 2);
    {
      var consequent_3 = ($$anchor2) => {
        ...
        reset(pre);
        var div_2 = sibling(pre, 2);
        each(
          div_2,
          5,
          () => (get2(selected), untrack(() => formatMetadata(get2(selected).metadata))),
          index,
          ($$anchor3, $$item) => {
        ...
        var node_7 = sibling(div_2, 2);
        {
          var consequent_2 = ($$anchor3) => {
            ...
            each(node_8, 1, () => get2(selectedEdges), index, ($$anchor4, edge) => {
              var p_2 = root_5();
              var strong_1 = child(p_2);
              var text_8 = child(strong_1, true);
              reset(strong_1);
              var text_9 = sibling(strong_1);
              reset(p_2);
              template_effect(() => {
                set_text(text_8, (get2(edge), untrack(() => get2(edge).type)));
                set_text(text_9, ` (${(get2(edge), untrack(() => get2(edge).lifecycleState || "suggested")) ?? ""}, conf 
              ${(get2(edge), untrack(() => get2(edge).confidence ?? "n/a")) ?? ""}): ${(get2(edge), untrack(() => get2(edge).evidence || "inferred connection")) ?? ""}`);
              });
              append($$anchor4, p_2);
            });
            reset(div_3);
          ...
          if_block(node_7, ($$render) => {
            if (get2(selectedEdges), untrack(() => get2(selectedEdges).length > 0)) $$render(consequent_2);
          });
        }
        template_effect(() => {
          set_text(text_3, (get2(selected), untrack(() => get2(selected).label)));
          set_text(text_4, (get2(selected), untrack(() => get2(selected).type)));
          set_text(text_5, (get2(selected), untrack(() => get2(selected).preview)));
        });
      ...
      if_block(node_6, ($$render) => {
        if (get2(selected)) $$render(consequent_3);
  ...
  customElements.define("memory-graph", create_custom_element(MemoryGraph, { dataJson: {} }, [], [], { mode: "open" }));
})();
